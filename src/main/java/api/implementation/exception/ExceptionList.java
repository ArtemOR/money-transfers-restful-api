...
public enum ExceptionList {
    ...
    WRONG_NUMBER_FORMAT("id8", "Bad Request. Cannot cast string to number value", HttpStatus.BAD_REQUEST_400),
    CHOSE_DIFFERENT_ACCOUNT_IDS("id9", "accountFromId and accountToId parameters are equal. Please specify different.", HttpStatus.BAD_REQUEST_400);
