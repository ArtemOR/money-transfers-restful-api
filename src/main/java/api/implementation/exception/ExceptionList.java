...
public enum ExceptionList {
    ...
    ID_LIST_IS_EMPTY("id12", "Id list is empty", HttpStatus.BAD_REQUEST_400),
    PARTIAL_RESULT("id13", "Some records not found", HttpStatus.MULTI_STATUS_207),
    ALL_FAILED("id14", "No records found", HttpStatus.NOT_FOUND_404);
